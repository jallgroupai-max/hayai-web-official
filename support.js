...
// LOCAL PATCH (no viene de dc-runtime): REACT_URL / REACT_DOM_URL / BABEL_URL apuntan
// a ./vendor/ en vez de unpkg.com para no depender de un CDN externo en produccion.
// Los hashes *_SRI son los mismos de unpkg y siguen validando (verificado con sha384).
// Si regeneras este archivo con `bun run build`, vuelve a aplicar este cambio.
"use strict";
(() => {
